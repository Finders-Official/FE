...
export const ToastItem = ({ message, icon }: ToastItemProps) => {
  return (
    <div className="animate-toast-in bg-neutral-875/70 flex min-h-[3.75rem] w-[20.3125rem] items-center gap-[1rem] rounded-[1.125rem] border border-neutral-800 px-[1.25rem] py-[1rem] shadow-lg backdrop-blur-3xl">
      {/* 아이콘 영역 */}
      {icon && (
