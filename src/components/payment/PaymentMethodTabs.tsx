      ...
      {TABS.map((tab) => {
        ...
        return (
          <button
            ...
            aria-pressed={active}
            className={`flex h-[3.25rem] flex-1 items-center justify-center rounded-[0.75rem] px-4 py-[0.625rem] text-[0.875rem] leading-[1.55] font-semibold tracking-[-0.02em] text-neutral-100 ${
              active
